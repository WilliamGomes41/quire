...
TanStack Start, Better Auth, PGLite (or Postgres/Neon when `DATABASE_URL` is set), xAI `grok-4.6` for Keep understanding, two related search strings, related-page stance, and the optional take, one dedicated search API in the retrieval slot.
